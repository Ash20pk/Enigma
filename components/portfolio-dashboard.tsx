        ...
        <Card className="group relative bg-slate-900/40 border-slate-800/50 backdrop-blur-xl hover:bg-slate-900/60 transition-all duration-300">
          ...
          <CardHeader className="relative pb-3">
            <CardTitle className="text-sm font-medium text-slate-300 flex items-center gap-2">
              <div className="w-8 h-8 rounded-xl bg-gradient-to-r from-green-500/20 to-emerald-500/20 flex items-center justify-center">
          ...
          <CardContent className="relative">
            ...
            <div className="text-sm text-slate-400 mt-1">
              Across {portfolio.filter(token => token.usd_value > 0.01).length} assets
            </div>
          </CardContent>
        </Card>
